				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="<?php echo get_theme_file_uri('assets/img/blog1.jpg');?>" alt="#">
							</div>
							<div class="news-body">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="<?php echo get_theme_file_uri('assets/img/blog2.jpg');?>" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="<?php echo get_theme_file_uri('assets/img/blog3.jpg');?>" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
